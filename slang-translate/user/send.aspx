<%@ Page Title="" Language="C#" MasterPageFile="~/Master.User.master" AutoEventWireup="true" CodeFile="send.aspx.cs" Inherits="contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
    <!--   انشاء جدول ليتم احتواه العناصر داخله -->
        <table class="style1">
            <tr>
                <td class="style14">
    ...
    <table class="style4">
        <tr>
            <td class="style16">
                &nbsp;</td>
            <td class="style12">
             <!--   انشاء العنصر النص ليكون فيه اسم المستخدم المرسل وهو نفس اسم المستخدم المسجل -->
        ...
        <tr>
            <td class="style16">
             <!--   انشاء عنصر التحقق لكي لا يسمح باضافة حقل فارغ في النص اسم المستقبل -->
          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ...
            <td class="style12">
               <!--   انشاء العنصر النص ليكون فيه اسم مستخدم المستقبل لارسال الرساله اليه -->
        ...
        <tr>
            <td class="style16">
             <!--   انشاء عنصر التحقق لكي لا يسمح باضافة حقل فارغ في عنصر النص عنوان الرسالة-->
          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ...
            <td class="style12">
              <!--   انشاء العنصر النص ليكون فيه عنوان الرسالة المرسله -->
        ...
        <tr>
            <td class="style16">
               <!--   انشاء عنصر التحقق لكي لا يسمح باضافة حقل فارغ في عنصر النص الرسالة -->
          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ...
            <td class="style12">
                <!--   انشاء العنصر النص ليكون فيه نص الرسالة المرسله -->
        ...
        <tr>
            <td class="style17">
                &nbsp;</td>
            <td class="style12">
                <!--   انشاء العنصر النص ليكون فيه رسائل الخطأ او الاشعارات التي تفيد بنجاح ارسالة الرسالة او فشل -->
        ...
        <tr>
            <td class="style17">
                &nbsp;</td>
            <td class="style12">
                <!--   انشاء العنصر زر حيث يتم الضغط عليه لارسال الرسالة -->
