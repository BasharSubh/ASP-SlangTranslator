<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="prosearch.aspx.cs" Inherits="prosearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="style4">
        <tr>
            <td class="style9">
                            <!--اضافة عنصر زر ليقوم بتنفيذ اختيار المستخدم لطريقة البحث من خلال العنصر قائمة-->
            ...
            <td class="style14">
                            <!--اضافة عنصر قائمة منسدلة ليكون فيا انواع البحث عن المصطلحات-->
            ...
            <td class="style15">
                <strong>
                 <!--اضافة عنصر النص لعرض النص اختر نوع البحث-->
               ...
               <!--اضافة عنصر قائمة وهو مرتبط مع قاعدة البيانات تابع للكيان نوع الكلمة -->
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT [place_name] FROM [places]"></asp:SqlDataSource>
                        <!--اضافة عنصر قائمة يحوي جميع الاحرف الابجدية ليختار المستخدم منها لعملية البحث-->
                ...
                <br />
                    <!--اضافة العنصر زر لتنفيذ عمليه البحث-->
                <asp:Button ID="Button2" runat="server" BackColor="#3399FF" BorderColor="Blue" 
                    Text="بحث" Visible="False" Width="170px" onclick="Button2_Click1" />
                        <!--اضافة العنصر تقويم ليختار المستخدم منها تاريخ لتنفيذ عمليه البحث-->
        ...
        <tr>
            <td class="style9">
                &nbsp;</td>
            <td class="style14">
                <!--اضافة العنصر نص لعرض نص حسب العملية المخارة من قبل المستخدم وهذا مبرمج في الكود الخلفي-->
        ...
        <div class="style6">
            ...
            <!--اضافة العنصر جريد فيو 1 لعرض نتائج من قاعدة البيانات-->
    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Justify" AutoGenerateColumns="False" 
      ...
      <!--اضافة عنصرالاتصال بقاعدة الينات ليقوم بعرض النتائج حسب الحرف وربطه في العنصر جريد فيو 1-->
       <!--يكون اختيار المستخدم عن طريق عنصر القائمة الذي يحوي الاحرف الابجدية العربية-->
    ...
    <!--اضافة العنصر جريد فيو 2 لعرض نتائج من قاعدة البيانات-->
    <asp:GridView ID="GridView2" runat="server" HorizontalAlign="Justify" AutoGenerateColumns="False" 
     ...
     <!--اضافة عنصرالاتصال بقاعدة الينات ليقوم بعرض النتائج حسب المكان وربطه في العنصر جريد فيو 2-->
       <!--يكون اختيار المستخدم عن طريق عنصر القائمة الذي هو بدوره مرتبط بعنصر اتصال مع قاعدة البيانات لعرض -->
        <!--الاسطر في الجدول المكان-->
    ...
    <p>
     <!--اضافة العنصر جريد فيو 3 لعرض نتائج من قاعدة البيانات-->
    <asp:GridView ID="GridView3" runat="server" HorizontalAlign="Justify" AutoGenerateColumns="False" 
     ...
     <!--اضافة عنصرالاتصال بقاعدة الينات ليقوم بعرض النتائج حسب نوع المصطلح وربطه في العنصر جريد فيو 3-->
       <!--يكون اختيار المستخدم عن طريق عنصر القائمة الذي هو بدوره مرتبط بعنصر اتصال مع قاعدة البيانات لعرض -->
        <!--الاسطر في الجدول النوع-->
    ...
    <p>
    <!--اضافة العنصر جريد فيو 4 لعرض نتائج من قاعدة البيانات-->
    ...
    <!--اضافة عنصرالاتصال بقاعدة الينات ليقوم بعرض النتائج حسب  التاريخ وربطه في العنصر جريد فيو 4-->
       <!--يكون اختيار المستخدم عن طريق عنصر التقويم حيث عند اختيار تاريخ ما يكون عرض النتائج حسب التاريخ المختار -->
