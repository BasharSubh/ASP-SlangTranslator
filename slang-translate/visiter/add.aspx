...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <table class="style4">
            <tr>
                <td class="style8">
                <!--اضافة عنصر تحقق حيث لا يجب ترك الحقل اسم المصطلح فارغ-->
          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
              ...
              لا يجب ترك الحقل فارغ
                ...
                <td class="style8">
                    مثال : كيفك </td>
                <td class="style8">
                 <!--اضافة عنصر نص لكتابة المصطلح المراد حفظه فيه-->
            ...
            <tr>
                <td class="style8">
                <!--اضافة عنصر تحقق حيث لا يجب ترك الحقل شرح المصطلح فارغ-->
                ...
                <td class="style8">
                    مثال : كيف حالك</td>
                <td class="style8">
                 <!--اضافة عنصر نص لكتابة شرح المصطلح المراد تسجيله-->
        ...
        <div class="style2">
          <!--اضافة عنصر كود التحقق بحيث لا يستطلع المستخدم ادخال مصطلح جديد الا بتحقق الكود المدخل-->
        <rsv:CaptchaControl ID="captcha1" runat ="server" CaptchaLength="5" 
            ...
            <tr>
                <td class="style8">
                    &nbsp;</td>
                <td class="style8">
                  <!--اضافة عنصرالتحقق حيث لا يجب ترك حقل اذافة رمز كود التحقق فارغ -->
                ...
                <td class="style12">
                  <!--اضافة عنصر النص ليتيح للمستخدم بستجيل الزمز التابع للصورة في كود التحقق-->
            ...
            <tr>
                ...
                <td class="style8">
                    &nbsp;</td>
                <td class="style8">
                  <!--اضافة عنصرالزر لتسجيل المصطلح الجديد ان استوفا شروط عناصر التحقق السابقة-->
    ...
    <p>
      <!--اضافة نص لعرض شرح مسبط عن الصفحة-->
          &nbsp;<p class="style9">

              المساهمة في تحسين القاموس بالادخال اكبر عدد ممكن من المصطلحات العامية مع وضح 
              ترجمة متوقعة اليها ليتم الموافقة عليها فيما بعد 
    </p>
    <p class="style9">
