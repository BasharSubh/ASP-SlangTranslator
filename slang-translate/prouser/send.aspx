<%@ Page Title="" Language="C#" MasterPageFile="~/Master.prouser.master" AutoEventWireup="true" CodeFile="send.aspx.cs" Inherits="contact" %>
          ...
          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ...
            <td class="style12">
                <asp:TextBox ID="TextBox3" style="resize:none" runat="server" Height="186px" TextMode="MultiLine" 
                    Width="536px" BorderColor="Blue"></asp:TextBox>
            </td>
            <td class="style11">
